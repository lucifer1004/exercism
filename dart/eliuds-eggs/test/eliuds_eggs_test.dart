...
void main() {
  ...
  test("negative input throws ArgumentError", () {
    expect(() => egg_counter.count(-1), throwsArgumentError);
  }, skip: false);

  test("large negative input throws ArgumentError", () {
    expect(() => egg_counter.count(-2000000000), throwsArgumentError);
  }, skip: false);
}
